...
filelocation=os.path.join('Resources', 'budget_data.csv') # assigns filepath of data csv file to variable
with open(filelocation, "r") as new_csv: # Open csv file in read mode and assign to variable
    ...
    txtlocation=os.path.join("Analysis", "PyBank Financial Analysis.txt")
    with open(txtlocation, "w") as new_txt:
